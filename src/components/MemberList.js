...
class MemberList extends React.Component {
    ...
    handleFind(e) {
        ...
        if(input === '') {
            ...
            let found = [];
            for(let member of this.state.list) {
                if(member && regex.exec(member.phone))
                    found.push(member);
            }
            this.setState({
                list : found,
            ...
            <div>
                ...
                <Table
                    ...
                    <thead>
                        ...
                        <th style={styles.table_th}>기념일</th>
                    </thead>
                    <tbody>
                    {
                        this.state.list.map((r, i) => {
                            ...
                            if(i>=(active-1)*10 && i<active*10) {
                                ...
                                return (
                                    <tr key={r.phone} style={styles.table_tr} onClick={() => {
                ...
                <FormGroup controlId="formControlsText">
                    <FormControl style={styles.findForm}
                         type='text'
